...
ActiveRecord::Schema.define(version: 2019_08_06_214643) do
  ...
  create_table "user_project_reports", force: :cascade do |t|
    t.integer "week"
    t.integer "estimated_cost"
    t.integer "real_cost"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.bigint "project_member_id"
    t.index ["project_member_id"], name: "index_user_project_reports_on_project_member_id"
  end
  ...
  add_foreign_key "user_project_reports", "project_members"
